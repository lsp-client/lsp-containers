...
- **Size Optimized**: We utilize multi-stage builds and minimal base images to ensure the smallest possible footprint. See [IMAGE_OPTIMIZATION.md](docs/IMAGE_OPTIMIZATION.md) for detailed optimization strategies.
